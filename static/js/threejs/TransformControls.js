...
THREE.TransformControls = function ( camera, domElement ) {
	...
	this.pointerMove = function( pointer ) {
		...
		if ( mode === 'translate' ) {
			...
			var ROTATION_SPEED = 15 / worldPosition.distanceTo( _tempVector.setFromMatrixPosition( this.camera.matrixWorld ) );
...
THREE.TransformControlsGizmo = function () {
	...
	matLineYellowTransparent.opacity = 0;
	...
	var pickerRotate = {
		...
		Y: [
            ...
            [new THREE.Mesh(new THREE.BoxGeometry( 1, 1,1 ), matInvisible ), [ 0, 0, 0 ] ],
		],
		Z: [
